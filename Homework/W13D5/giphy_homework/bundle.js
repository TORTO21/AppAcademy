...
function (_React$Component) {
  ...
  _createClass(GiphysSearch, [{
    ...
    value: function handleSubmit(e) {
      e.preventDefault();
      var searchTerm = this.state; // this.props.fetchSearchGiphys({ searchTerm })
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("form", {
        action: ""
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h1", null, "Giphy Search"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("label", null, "Search:", react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("input", {
        type: "text",
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "fetchSearchGiphys", function() { return fetchSearchGiphys; });
var fetchSearchGiphys = function fetchSearchGiphys(searchTerm) {
  var APIKey = '8cZgGrMrip7PKJDEZLZu5CqmwyrSgMCL';
  return $.ajax({
    method: 'GET',
    dataType: 'json',
    // url: `https://api.giphy.com/v1/gifs/search?q=${searchTerm}&api_key=dc6zaTOxFJmzC&limit=2`
    url: "https://api.giphy.com/v1/gifs/search?api_key=".concat(APIKey, "&q=").concat(searchTerm, "&limit=2&offset=0&rating=G&lang=en")
  });
};
